  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        label: '新界',
        children: [
          { value: '810301', label: '葵青区' },
          { value: '810302', label: '荃湾区' },
          { value: '810303', label: '屯门区' },
          { value: '810304', label: '元朗区' },
          { value: '810305', label: '北区' },
          { value: '810306', label: '大埔区' },
          { value: '810307', label: '沙田区' },
          { value: '810308', label: '西贡区' },
    ...
    children: [
      {
        ...
        label: '澳门半岛',
        children: [
          { value: '820101', label: '大堂区' },
          { value: '820102', label: '望德堂区' },
          { value: '820103', label: '风顺堂区' },
          { value: '820104', label: '花地玛堂区' },
          { value: '820105', label: '圣安多尼堂区' }
        ]
      },
      {
        value: '820200',
        label: '澳门外岛',
        children: [
          { value: '820201', label: '嘉模堂区（氹仔）' },
          { value: '820202', label: '圣方济各堂区（路环）' }
        ]
      }
    ]
  },
    ...
    children: [
      {
        ...
        label: '台北市',
        children: [
          { value: '710101', label: '大安区' },
          { value: '710102', label: '内湖区' },
          { value: '710103', label: '士林区' },
          { value: '710104', label: '文山区' },
          { value: '710105', label: '北投区' },
          { value: '710106', label: '中山区' },
          { value: '710107', label: '信义区' },
          { value: '710108', label: '松山区' },
          { value: '710109', label: '万华区' },
          { value: '710110', label: '中正区' },
          { value: '710111', label: '大同区' },
          { value: '710112', label: '南港区' }
        ]
      },
      {
        value: '710200',
        label: '新北市',
        children: [
          { value: '710201', label: '板桥区' },
          { value: '710202', label: '新庄区' },
          { value: '710203', label: '中和区' },
          { value: '710204', label: '三重区' },
          { value: '710205', label: '新店区' },
          { value: '710206', label: '土城区' },
          { value: '710207', label: '永和区' },
          { value: '710208', label: '芦洲区' },
          { value: '710209', label: '汐止区' },
          { value: '710210', label: '树林区' },
          { value: '710211', label: '淡水区' },
          { value: '710212', label: '三峡区' },
          { value: '710213', label: '林口区' },
          { value: '710214', label: '莺歌区' },
          { value: '710215', label: '五股区' },
          { value: '710216', label: '泰山区' },
          { value: '710217', label: '瑞芳区' },
          { value: '710218', label: '八里区' },
          { value: '710219', label: '深坑区' },
          { value: '710220', label: '三芝区' },
          { value: '710221', label: '万里区' },
          { value: '710222', label: '金山区' },
          { value: '710223', label: '贡寮区' },
          { value: '710224', label: '石门区' },
          { value: '710225', label: '双溪区' },
          { value: '710226', label: '石碇区' },
          { value: '710227', label: '坪林区' },
          { value: '710228', label: '乌来区' },
          { value: '710229', label: '平溪区' }
        ]
      },
      {
        value: '710300',
        label: '桃园市',
        children: [
          { value: '710301', label: '桃园区' },
          { value: '710302', label: '中坜区' },
          { value: '710303', label: '平镇区' },
          { value: '710304', label: '八德区' },
          { value: '710305', label: '杨梅区' },
          { value: '710306', label: '芦竹区' },
          { value: '710307', label: '龟山区' },
          { value: '710308', label: '龙潭区' },
          { value: '710309', label: '大溪区' },
          { value: '710310', label: '大园区' },
          { value: '710311', label: '观音区' },
          { value: '710312', label: '新屋区' },
          { value: '710313', label: '复兴区' }
        ]
      },
      {
        value: '710400',
        label: '台中市',
        children: [
          { value: '710401', label: '北屯区' },
          { value: '710402', label: '西屯区' },
          { value: '710403', label: '大里区' },
          { value: '710404', label: '太平区' },
          { value: '710405', label: '南屯区' },
          { value: '710406', label: '丰原区' },
          { value: '710407', label: '东区' },
          { value: '710408', label: '南区' },
          { value: '710409', label: '西区' },
          { value: '710410', label: '北区' },
          { value: '710411', label: '中区' },
          { value: '710412', label: '潭子区' },
          { value: '710413', label: '大雅区' },
          { value: '710414', label: '沙鹿区' },
          { value: '710415', label: '清水区' },
          { value: '710416', label: '龙井区' },
          { value: '710417', label: '大甲区' },
          { value: '710418', label: '乌日区' },
          { value: '710419', label: '神冈区' },
          { value: '710420', label: '雾峰区' },
          { value: '710421', label: '梧栖区' },
          { value: '710422', label: '大肚区' },
          { value: '710423', label: '后里区' },
          { value: '710424', label: '东势区' },
          { value: '710425', label: '外埔区' },
          { value: '710426', label: '新社区' },
          { value: '710427', label: '大安区' },
          { value: '710428', label: '石冈区' },
      ...
      },
      {
        ...
        label: '台南市',
        children: [
          { value: '710501', label: '永康区' },
          { value: '710502', label: '安南区' },
          { value: '710503', label: '东区' },
          { value: '710504', label: '北区' },
          { value: '710505', label: '南区' },
          { value: '710506', label: '中西区' },
          { value: '710507', label: '新营区' },
          { value: '710508', label: '仁德区' },
          { value: '710509', label: '归仁区' },
          { value: '710510', label: '安平区' },
          { value: '710511', label: '佳里区' },
          { value: '710512', label: '善化区' },
          { value: '710513', label: '麻豆区' },
          { value: '710514', label: '新化区' },
          { value: '710515', label: '新市区' },
          { value: '710516', label: '关庙区' },
          { value: '710517', label: '安定区' },
          { value: '710518', label: '白河区' },
          { value: '710519', label: '学甲区' },
          { value: '710520', label: '盐水区' },
          { value: '710521', label: '西港区' },
          { value: '710522', label: '下营区' },
          { value: '710523', label: '后壁区' },
          { value: '710524', label: '七股区' },
          { value: '710525', label: '六甲区' },
          { value: '710526', label: '官田区' },
          { value: '710527', label: '柳营区' },
          { value: '710528', label: '东山区' },
          { value: '710529', label: '将军区' },
          { value: '710530', label: '玉井区' },
          { value: '710531', label: '北门区' },
          { value: '710532', label: '大内区' },
          { value: '710533', label: '楠西区' },
          { value: '710534', label: '南化区' },
          { value: '710535', label: '山上区' },
          { value: '710536', label: '左镇区' },
          { value: '710537', label: '龙崎区' }
        ]
      },
      {
        value: '710600',
        label: '高雄市',
        children: [
          { value: '710601', label: '凤山区' },
          { value: '710602', label: '三民区' },
          { value: '710603', label: '左营区' },
          { value: '710604', label: '前镇区' },
          { value: '710605', label: '楠梓区' },
          { value: '710606', label: '苓雅区' },
          { value: '710607', label: '小港区' },
          { value: '710608', label: '鼓山区' },
          { value: '710609', label: '大寮区' },
          { value: '710610', label: '冈山区' },
          { value: '710611', label: '仁武区' },
          { value: '710612', label: '林园区' },
          { value: '710613', label: '路竹区' },
          { value: '710614', label: '新兴区' },
          { value: '710615', label: '鸟松区' },
          { value: '710616', label: '大树区' },
          { value: '710617', label: '美浓区' },
          { value: '710618', label: '桥头区' },
          { value: '710619', label: '旗山区' },
          { value: '710620', label: '梓官区' },
          { value: '710621', label: '大社区' },
          { value: '710622', label: '茄萣区' },
          { value: '710623', label: '燕巢区' },
          { value: '710624', label: '湖内区' },
          { value: '710625', label: '阿莲区' },
          { value: '710626', label: '旗津区' },
          { value: '710627', label: '前金区' },
          { value: '710628', label: '盐埕区' },
          { value: '710629', label: '弥陀区' },
          { value: '710630', label: '内门区' },
          { value: '710631', label: '永安区' },
          { value: '710632', label: '六龟区' },
          { value: '710633', label: '杉林区' },
          { value: '710634', label: '田寮区' },
          { value: '710635', label: '甲仙区' },
          { value: '710636', label: '桃源区' },
          { value: '710637', label: '那玛夏区' },
          { value: '710638', label: '茂林区' }
        ]
      },
      {
        value: '710700',
        label: '基隆市',
        children: [
          { value: '710701', label: '安乐区' },
          { value: '710702', label: '七堵区' },
          { value: '710703', label: '信义区' },
          { value: '710704', label: '中正区' },
          { value: '710705', label: '中山区' },
          { value: '710706', label: '仁爱区' },
          { value: '710707', label: '暖暖区' }
        ]
      },
      {
        value: '710800',
      ...
      },
      {
        ...
        children: [
          ...
          { value: '711002', label: '竹东镇' },
          { value: '711003', label: '新埔镇' },
          { value: '711004', label: '关西镇' },
          { value: '711005', label: '湖口乡' },
          { value: '711006', label: '新丰乡' },
          { value: '711007', label: '芎林乡' },
          { value: '711008', label: '宝山乡' },
          { value: '711009', label: '横山乡' },
          { value: '711010', label: '尖石乡' },
          { value: '711011', label: '北埔乡' },
          { value: '711012', label: '峨眉乡' },
          { value: '711013', label: '五峰乡' }
        ]
      },
      {
        value: '711100',
        label: '苗栗县',
        children: [
          { value: '711101', label: '头份市' },
          { value: '711102', label: '苗栗市' },
          { value: '711103', label: '竹南镇' },
          { value: '711104', label: '苑里镇' },
          { value: '711105', label: '后龙镇' },
          { value: '711106', label: '通霄镇' },
          { value: '711107', label: '卓兰镇' },
          { value: '711108', label: '公馆乡' },
          { value: '711109', label: '铜锣乡' },
          { value: '711110', label: '三义乡' },
          { value: '711111', label: '大湖乡' },
          { value: '711112', label: '造桥乡' },
          { value: '711113', label: '头屋乡' },
          { value: '711114', label: '南庄乡' },
          { value: '711115', label: '西湖乡' },
          { value: '711116', label: '三湾乡' },
          { value: '711117', label: '泰安乡' },
          { value: '711118', label: '狮潭乡' }
        ]
      },
      {
        value: '711200',
        label: '彰化县',
        children: [
          { value: '711201', label: '彰化市' },
          { value: '711202', label: '员林市' },
          { value: '711203', label: '和美镇' },
          { value: '711204', label: '鹿港镇' },
          { value: '711205', label: '溪湖镇' },
          { value: '711206', label: '二林镇' },
          { value: '711207', label: '田中镇' },
          { value: '711208', label: '北斗镇' },
          { value: '711209', label: '福兴乡' },
          { value: '711210', label: '花坛乡' },
          { value: '711211', label: '社头乡' },
          { value: '711212', label: '秀水乡' },
          { value: '711213', label: '伸港乡' },
          { value: '711214', label: '大村乡' },
          { value: '711215', label: '永靖乡' },
          { value: '711216', label: '埔心乡' },
          { value: '711217', label: '芳苑乡' },
          { value: '711218', label: '埔盐乡' },
          { value: '711219', label: '埤头乡' },
          { value: '711220', label: '溪州乡' },
          { value: '711221', label: '田尾乡' },
          { value: '711222', label: '芬园乡' },
          { value: '711223', label: '线西乡' },
          { value: '711224', label: '大城乡' },
          { value: '711225', label: '二水乡' },
          { value: '711226', label: '竹塘乡' }
        ]
      },
      {
        value: '711300',
        label: '南投县',
        children: [
          { value: '711301', label: '南投市' },
          { value: '711302', label: '草屯镇' },
          { value: '711303', label: '埔里镇' },
          { value: '711304', label: '竹山镇' },
          { value: '711305', label: '集集镇' },
          { value: '711306', label: '名间乡' },
          { value: '711307', label: '国姓乡' },
          { value: '711308', label: '鹿谷乡' },
          { value: '711309', label: '水里乡' },
          { value: '711310', label: '信义乡' },
          { value: '711311', label: '仁爱乡' },
          { value: '711312', label: '鱼池乡' },
          { value: '711313', label: '中寮乡' }
        ]
      },
      {
        value: '711400',
        label: '云林县',
        children: [
          { value: '711401', label: '斗六市' },
          { value: '711402', label: '虎尾镇' },
          { value: '711403', label: '西螺镇' },
          { value: '711404', label: '斗南镇' },
          { value: '711405', label: '北港镇' },
          { value: '711406', label: '土库镇' },
          { value: '711407', label: '麦寮乡' },
          { value: '711408', label: '古坑乡' },
          { value: '711409', label: '莿桐乡' },
          { value: '711410', label: '口湖乡' },
          { value: '711411', label: '二仑乡' },
          { value: '711412', label: '元长乡' },
          { value: '711413', label: '水林乡' },
          { value: '711414', label: '仑背乡' },
          { value: '711415', label: '台西乡' },
          { value: '711416', label: '四湖乡' },
          { value: '711417', label: '大埤乡' },
          { value: '711418', label: '林内乡' },
          { value: '711419', label: '东势乡' },
          { value: '711420', label: '褒忠乡' }
        ]
      },
      {
        value: '711500',
        label: '嘉义县',
        children: [
          { value: '711501', label: '朴子市' },
          { value: '711502', label: '太保市' },
          { value: '711503', label: '大林镇' },
          { value: '711504', label: '布袋镇' },
          { value: '711505', label: '民雄乡' },
          { value: '711506', label: '水上乡' },
          { value: '711507', label: '中埔乡' },
          { value: '711508', label: '竹崎乡' },
          { value: '711509', label: '新港乡' },
          { value: '711510', label: '东石乡' },
          { value: '711511', label: '六脚乡' },
          { value: '711512', label: '梅山乡' },
          { value: '711513', label: '义竹乡' },
          { value: '711514', label: '鹿草乡' },
          { value: '711515', label: '溪口乡' },
          { value: '711516', label: '番路乡' },
          { value: '711517', label: '阿里山乡' },
          { value: '711518', label: '大埔乡' }
        ]
      },
      {
        value: '711600',
        label: '屏东县',
        children: [
          { value: '711601', label: '屏东市' },
          { value: '711602', label: '潮州镇' },
          { value: '711603', label: '东港镇' },
          { value: '711604', label: '恒春镇' },
          { value: '711605', label: '内埔乡' },
          { value: '711606', label: '万丹乡' },
          { value: '711607', label: '新园乡' },
          { value: '711608', label: '长治乡' },
          { value: '711609', label: '里港乡' },
          { value: '711610', label: '盐埔乡' },
          { value: '711611', label: '高树乡' },
          { value: '711612', label: '枋寮乡' },
          { value: '711613', label: '九如乡' },
          { value: '711614', label: '万峦乡' },
          { value: '711615', label: '佳冬乡' },
          { value: '711616', label: '林边乡' },
          { value: '711617', label: '竹田乡' },
          { value: '711618', label: '崁顶乡' },
          { value: '711619', label: '琉球乡' },
          { value: '711620', label: '麟洛乡' },
          { value: '711621', label: '南州乡' },
          { value: '711622', label: '新埤乡' },
          { value: '711623', label: '车城乡' },
          { value: '711624', label: '满州乡' },
          { value: '711625', label: '三地门乡' },
          { value: '711626', label: '来义乡' },
          { value: '711627', label: '玛家乡' },
          { value: '711628', label: '枋山乡' },
          { value: '711629', label: '泰武乡' },
          { value: '711630', label: '牡丹乡' },
          { value: '711631', label: '狮子乡' },
          { value: '711632', label: '春日乡' },
          { value: '711633', label: '雾台乡' }
        ]
      },
      {
        value: '711700',
        label: '宜兰县',
        children: [
          { value: '711701', label: '宜兰市' },
          { value: '711702', label: '罗东镇' },
          { value: '711703', label: '苏澳镇' },
          { value: '711704', label: '头城镇' },
          { value: '711705', label: '冬山乡' },
          { value: '711706', label: '五结乡' },
          { value: '711707', label: '礁溪乡' },
          { value: '711708', label: '员山乡' },
          { value: '711709', label: '壮围乡' },
          { value: '711710', label: '三星乡' },
          { value: '711711', label: '大同乡' },
          { value: '711712', label: '南澳乡' }
        ]
      },
      {
        value: '711800',
        label: '花莲县',
        children: [
          { value: '711801', label: '花莲市' },
          { value: '711802', label: '玉里镇' },
          { value: '711803', label: '凤林镇' },
          { value: '711804', label: '吉安乡' },
          { value: '711805', label: '新城乡' },
          { value: '711806', label: '寿丰乡' },
          { value: '711807', label: '秀林乡' },
          { value: '711808', label: '光复乡' },
          { value: '711809', label: '瑞穗乡' },
          { value: '711810', label: '富里乡' },
          { value: '711811', label: '万荣乡' },
          { value: '711812', label: '卓溪乡' },
          { value: '711813', label: '丰滨乡' }
        ]
      },
      {
        value: '711900',
        label: '台东县',
        children: [
          { value: '711901', label: '台东市' },
          { value: '711902', label: '卑南乡' },
          { value: '711903', label: '成功镇' },
          { value: '711904', label: '太麻里乡' },
          { value: '711905', label: '关山镇' },
          { value: '711906', label: '东河乡' },
          { value: '711907', label: '池上乡' },
          { value: '711908', label: '鹿野乡' },
          { value: '711909', label: '长滨乡' },
          { value: '711910', label: '大武乡' },
          { value: '711911', label: '兰屿乡' },
          { value: '711912', label: '海端乡' },
          { value: '711913', label: '绿岛乡' },
          { value: '711914', label: '金峰乡' },
          { value: '711915', label: '延平乡' },
          { value: '711916', label: '达仁乡' }
        ]
      },
      {
        value: '712000',
        label: '澎湖县',
        children: [
          { value: '712001', label: '马公市' },
          { value: '712002', label: '湖西乡' },
          { value: '712003', label: '白沙乡' },
          { value: '712004', label: '西屿乡' },
          { value: '712005', label: '望安乡' },
          { value: '712006', label: '七美乡' }
        ]
      }
    ]
  }
