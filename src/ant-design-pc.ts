...
const district: CascaderOption[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { value: '710300', label: '桃园市' },
      { value: '710400', label: '台中市' },
      { value: '710500', label: '台南市' },
      { value: '710600', label: '高雄市' },
      { value: '710700', label: '基隆市' },
      { value: '710800', label: '新竹市' },
      { value: '710900', label: '嘉义市' },
      { value: '711000', label: '新竹县' },
      { value: '711100', label: '苗栗县' },
      { value: '711200', label: '彰化县' },
      { value: '711300', label: '南投县' },
      { value: '711400', label: '云林县' },
      { value: '711500', label: '嘉义县' },
      { value: '711600', label: '屏东县' },
      { value: '711700', label: '宜兰县' },
      { value: '711800', label: '花莲县' },
      { value: '711900', label: '台东县' },
      { value: '712000', label: '澎湖县' }
    ]
  }
];
